        ...
        <tbody>
            <form method="POST" action="select_candidate.php">
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    echo $selected;
                    echo "</td><td>";
                    $test_clear = mysql_query("Select * from students_test_clear where company_id = '$company_id' and jobid = '$_GET[id]' and usn = '$row[0]'") or die(mysql_error());
                    if(mysql_num_rows($test_clear) > 0){
                        echo "<span class='text-success'>Test Cleared</span>";
                    } else {
                        echo "";
                    }
                    echo "</td></tr>";
